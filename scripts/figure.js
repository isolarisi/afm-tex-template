...
// Description: Encloses the current selection in \begin{figure}
// Author: Rebro Ivan
// Version: 0.1
// Date: 2017-10-26
...
addOrRemove("\\begin{figure}[h] \\hspace*{-1.5cm}{\\includegraphics[width=19cm]{pic/<>.png}} \\caption{","} \\label{ris:<>}\\end{figure}");
